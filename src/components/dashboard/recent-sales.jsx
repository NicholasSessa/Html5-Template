...
export default function RecentSales() {
	...
	<div className="row">
		...
		<div className={classes.whiteBox}>
			...
			<h3 className={`${classes.boxTitle} mb-0`}>Recent sales</h3>
			...
			<table className="table no-wrap">
				...
				<tr>
				    ...
				    <td>SALE</td>
				    <td className="txt-oflo">April 18, 2024</td>
				...
				<tr>
				    ...
				    <td>EXTENDED</td>
				    <td className="txt-oflo">April 19, 2024</td>
				...
				<tr>
				    ...
				    <td>TAX</td>
				    <td className="txt-oflo">April 20, 2024</td>
				...
				<tr>
				    ...
				    <td>SALE</td>
				    <td className="txt-oflo">April 21, 2024</td>
				    <td><span className="text-success">$24</span></td>
				</tr>
				<tr>
				    <td>6</td>
				    ...
				    <td>SALE</td>
				    <td className="txt-oflo">April 23, 2024</td>
				...
				<tr>
				    ...
				    <td>MEMBER</td>
				    <td className="txt-oflo">April 22, 2024</td>
